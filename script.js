        ...
        scoresHTML += `
            <div class="score-item">
                <div class="score-item-header">
                    ...
                    <div>
                        <div class="score-item-value">${score.toFixed(2)}</div>
                        <div class="score-item-max">Max: ${data.maxScore.toFixed(2)}</div>
                    </div>
                </div>
                <div class="progress-bar-mini">
                    <div class="progress-bar-fill" style="width: ${(score/data.maxScore)*100}%"></div>
                </div>
            </div>
        `;
        totalScore += score;
